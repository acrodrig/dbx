...
import { createTables, dbInit, generator, getProvider } from "./helpers.ts";
...
// const { Account: dynamicSchema } = await Schemas.generateSchemas(classFiles, import.meta.dirname! + "/../", true);
const dynamicSchemas = await Schemas.generate(classFiles, generator, BASE, true);
